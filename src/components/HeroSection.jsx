    ...
    <section className="min-h-screen flex items-center justify-center bg-white">
      <div className="container mx-auto px-6 py-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-6xl md:text-7xl font-medium mb-8 text-black leading-none tracking-tight animate-fade-up">
            Creamos productos digitales excepcionales
          </h1>
          
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-up" style={{ animationDelay: '100ms' }}>
