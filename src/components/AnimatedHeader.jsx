...
const AnimatedHeader = ({ showThemeToggle = true }) => {
    ...
    >
      <div className="container mx-auto px-6">
        <nav className="flex items-center justify-between h-20">
          <motion.a 
            href="/" 
            className="text-2xl font-bold tracking-tight text-black dark:text-white font-display"
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative services-dropdown">
              ...
              <AnimatePresence>
                {isServicesOpen && (
                  <motion.div 
                    className="absolute top-full left-0 mt-1 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-xl rounded-md overflow-hidden z-50"
            ...
            <motion.a
              href="/contacto"
              className="px-8 py-3 bg-black dark:bg-gray-200 text-white dark:text-gray-900 font-medium hover:bg-gray-800 dark:hover:bg-gray-300 transition-all duration-200 rounded-button"
          ...
          >
            <motion.div className="w-6 h-5 relative flex flex-col justify-between">
              <motion.span 
                className="block h-0.5 w-full bg-black dark:bg-gray-200"
                animate={{ 
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              className="lg:hidden absolute top-20 left-0 w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 mobile-menu"
              ...
              <div className="container mx-auto px-6 py-8">
                {navItems.map((item, index) => (
                  <motion.a
                    ...
                    className="block py-4 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium transition-colors duration-200 border-b border-gray-100 dark:border-gray-800"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                ...
                >
                  ...
                  <a
                    href="/contacto"
                    onClick={() => setIsMenuOpen(false)}
                    className="flex-1 ml-4 px-8 py-3 bg-black dark:bg-gray-200 text-white dark:text-gray-900 font-medium text-center hover:bg-gray-800 dark:hover:bg-gray-300 transition-all duration-200 rounded-button"
                  >
                    Hablemos
                  </a>
                </motion.div>
